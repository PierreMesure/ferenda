...
# "…fa" is the two Statskontoret/ESV samlingar, whose documents are published
# as föreskrifter och allmänna råd rather than as a författningssamling
_FS_SLUG = r"(?:[a-zåäö]+(?:fs|fa)|bfnar|rams|lbs)"
